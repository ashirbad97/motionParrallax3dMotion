...
public class GazeRecorder : MonoBehaviour
{
    ...
    string OutputFolder = subjectData.subjectTrialsDirPath;
    ...
    void Start () 
    {
        // By default on start of the scene starts recording
        shouldRecord = true;
    ...
    void Update()
    {
        ...
        // Currently Saved to "Enter" in the Editor as this keyword takes to the next Scene and the recordng is stopped by default
